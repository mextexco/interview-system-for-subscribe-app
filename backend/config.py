...
INTERVIEW_COURSES = {
    ...
    "entertainment_deep": {
        ...
        "question_topics": [
            ...
            "ゲームはしますか？",
            "本や漫画は読みますか？",
            "コンテンツを楽しむとき、ながら見と集中して見る、どちら派ですか？",
        ]
    },
    "travel_explorer": {
        "name": "旅行・おでかけ",
    ...
    "daily_pain": {
        ...
        "question_topics": [
            ...
            "買ったのにほとんど使っていないモノや道具はありますか？",
            "試してみたけど続かなかった習慣や活動はありますか？",
    ...
    "career_growth": {
        ...
        "question_topics": [
            "今の仕事や職場に満足していますか？",
            "今の仕事やキャリアアップに向けて、取り組んでいることや身につけたいスキルはありますか？",
            "副業・独立・転職に興味はありますか？",
            "AIなどテクノロジーの変化に、不安と期待どちらを感じますか？",
            "5年後、どんな自分でいたいですか？",
    ...
    "learning_curiosity": {
        ...
        "question_topics": [
            ...
            "学ぶとき、隙間時間でちょっとずつ派と、まとめてがっつり派、どちらですか？",
